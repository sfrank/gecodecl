...
(cffi:defcfun ("gecode_varargs_delete_sap" gecode_varargs_delete_sap) :void
  (v :pointer))
...
(cffi:defcfun ("gecode_intargs_delete_sap" gecode_intargs_delete_sap) :void
  (v :pointer))
...
(cffi:defcfun ("gecode_floatargs_delete_sap" gecode_floatargs_delete_sap) :void
  (v :pointer))
...
(cffi:defcfun ("gecode_intsetargs_delete_sap" gecode_intsetargs_delete_sap) :void
  (v :pointer))
...
(cffi:defcfun ("gecode_symhandleargs_delete_sap" gecode_symhandleargs_delete_sap) :void
  (v :pointer))
...
(cffi:defcfun ("gecode_space_delete_sap" gecode_space_delete_sap) :void
  (space :pointer))
...
(cffi:defcfun ("gecode_symmetryhandle_delete_sap" gecode_symmetryhandle_delete_sap) :void
  (sh :pointer))

(cffi:defcfun ("gecode_brancherhandle_delete" gecode_brancherhandle_delete) :void
  (bh brancherhandle-type))

(cffi:defcfun ("gecode_brancherhandle_delete_sap" gecode_brancherhandle_delete_sap) :void
  (bh :pointer))
...
(cffi:defcfun ("gecode_ivar_selector_delete_sap" gecode_ivar_selector_delete_sap) :void
  (s :pointer))
...
(cffi:defcfun ("gecode_ival_selector_delete_sap" gecode_ival_selector_delete_sap) :void
  (s :pointer))
...
(cffi:defcfun ("gecode_dfs_engine_delete_sap" gecode_dfs_engine_delete_sap) :void
  (dfs :pointer))
...
(cffi:defcfun ("gecode_bab_engine_delete_sap" gecode_bab_engine_delete_sap) :void
  (bab :pointer))
...
(cffi:defcfun ("gecode_rbs_dfs_engine_delete_sap" gecode_rbs_dfs_engine_delete_sap) :void
  (rbs :pointer))
...
(cffi:defcfun ("gecode_rbs_bab_engine_delete_sap" gecode_rbs_bab_engine_delete_sap) :void
  (rbs :pointer))
...
(cffi:defcfun ("gecode_DFA_delete_sap" gecode_DFA_delete_sap) :void
  (d :pointer))
...
(cffi:defcfun ("gecode_TupleSet_delete_sap" gecode_TupleSet_delete_sap) :void
  (d :pointer))
...
(cffi:defcfun ("gecode_fvar_selector_delete_sap" gecode_fvar_selector_delete_sap) :void
  (s :pointer))
...
(cffi:defcfun ("gecode_intset_delete_sap" gecode_intset_delete_sap) :void
  (iset :pointer))
...
(cffi:defcfun ("gecode_svar_selector_delete_sap" gecode_svar_selector_delete_sap) :void
  (s :pointer))

(cffi:defcfun ("gecode_sval_selector_delete" gecode_sval_selector_delete) :void
  (s setvalselector-type))

(cffi:defcfun ("gecode_sval_selector_delete_sap" gecode_sval_selector_delete_sap) :void
  (s :pointer))
